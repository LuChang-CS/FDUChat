...
import com.fudan.im.fragment.MessageFragment;
...
public class ApplicationData {
    ...
    public Bitmap getFriendPhoto(int userid) {
        ...
        if (userid == mUser.getId()) {
            ...
            for (User u : mFriendList) {
                if (u.getId() == userid) {
                    ...
                    if (photo != null) {
                        photoBitmap = PhotoUtils.getBitmap(u.getPhoto());
                    }
                    break;
                }
            }
	...
	public void setNewUser(User user) { this.mUser = user; this.mUserPhoto = PhotoUtils.getBitmap(user.getPhoto()); }
